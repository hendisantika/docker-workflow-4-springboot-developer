...
ADD target/docker-workflow-4-springboot-developer.jar docker-workflow-4-springboot-developer.jar
...
#ENTRYPOINT ["java","-Dspring.profiles.active=docker","-jar","docker-workflow-4-springboot-developer.jar"]
ENTRYPOINT ["java","-Dspring.profiles.active=docker","-jar","docker-workflow-4-springboot-developer.jar"]